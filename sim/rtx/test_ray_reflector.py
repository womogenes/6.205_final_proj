...
async def test_module(dut):
    ...
    dut.ray_income_light.value = make_fp24_vec3((1.0, 1.0, 1.0))

    dut.hit_location.value = make_fp24_vec3((0, 0, 0))
    dut.hit_normal.value = make_fp24_vec3(((1/3)**0.5, (1/3)**0.5, (1/3)**0.5))
    # dut.hit_normal.value = make_fp24_vec3((0, 0, 1))

    mat = make_material(color=make_fp24_vec3((1.0, 0.5, 0.25)), 
    ...
    for i in range(num_points):
        await RisingEdge(dut.reflect_valid)
