...
async def test_module(dut):
    ...
    async def do_test(a: tuple[float], b: float):
        """
    ...
    for _ in range(n_tests):
        ...
        b = (np.random.rand() - 0.5) * np.sqrt(1 << 15)
        prod = await do_test(a.tolist(), b)
